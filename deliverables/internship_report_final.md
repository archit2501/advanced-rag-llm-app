...
| 3. Tasks Accomplished in the Organization | 33 |
| 4. Results and Outcome | 50 |
| 5. Conclusion | 58 |
| References | 62 |
| Plagiarism Report | 63 |
| Weekly Progress Reports (WPRs) | 64 |
| Daily Diary | 69 |
| Appendix A. Configuration reference | 73 |
| Appendix B. Command reference | 75 |
| Appendix C. Glossary | 76 |
| Appendix D. Repository and artifacts | 77 |
...
| Figure | Title |
| --- | --- |
| Figure 1 | Chunking with overlap |
| Figure 2 | Hybrid retrieval with Reciprocal Rank Fusion |
| Figure 3 | The system architecture |
| Figure 4 | The data model |
| Figure 5 | The document ingestion flow |
| Figure 6 | The question answering flow |
| Figure 7 | Retrieval comparison on the default embedder |
| Figure 8 | Learned versus hashing embedder |
| Figure 9 | Answer-evaluation metrics by embedder |
